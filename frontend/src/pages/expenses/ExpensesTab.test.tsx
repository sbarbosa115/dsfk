...
describe('ExpensesTab', () => {
  it('shows a team lead what they are owed and records out-of-pocket expenses', async () => {
    currentUser = { id: 3, email: 'lead@x.co', fullName: 'Carlos', admin: false, superAdmin: false, memberships: [{ projectId: 1, projectName: 'Torre', role: 'TEAM_LEAD' }], impersonator: null, canImpersonate: false }
  ...
  it('lets the PM approve and reimburse selected expenses', async () => {
    currentUser = { id: 2, email: 'pm@x.co', fullName: 'PM', admin: false, superAdmin: false, memberships: [{ projectId: 1, projectName: 'Torre', role: 'PROJECT_MANAGER' }], impersonator: null, canImpersonate: false }
